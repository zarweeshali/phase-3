# Phase III Todo AI Chatbot - MCP Tools Specification

## Overview
This document specifies the MCP (Model Context Protocol) tools available to the AI agent for performing task operations in the Phase III Todo AI Chatbot system.
