...
This project implements an AI-powered todo chatbot following the Phase III architecture and specifications:

## Overview

The Phase III Todo AI Chatbot is a natural language task management system that allows users to manage their todos through conversational AI. The system uses Google's Gemini AI with MCP (Model Context Protocol) tools to perform task operations.
